...
<div class="bg-white rounded-lg shadow p-8 max-w-2xl">
    <form action="{{ route('admin.testimonials.update', $testimonial) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="role" value="{{ old('role', $testimonial->role) }}" placeholder="Contoh: Anggota Komunitas Mancing" class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-primary">
