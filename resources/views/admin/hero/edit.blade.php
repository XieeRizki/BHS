...
<style>
    ...
    .section-title { font-size: 1.1rem; font-weight: 700; color: var(--secondary); margin-bottom: 1rem; display: flex; align-items: center; gap: 0.5rem; }
...
<div class="form-box">
    <div class="section-title"><i class="fas fa-images"></i> Gambar Slideshow Saat Ini</div>
...
<div class="form-box">
    <form action="{{ route('admin.hero.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="section-title"><i class="fas fa-star"></i> Informasi Hero Banner</div>
        ...
        <div class="section-divider">
            <div class="section-title"><i class="fas fa-upload"></i> Upload Gambar</div>
        ...
        <div class="section-divider">
            <div class="section-title"><i class="fas fa-hand-pointer"></i> Call-to-Action Button</div>
            <div class="grid-2col">
                <div class="form-group">
        ...
        <button type="submit" class="btn btn-save mt-4">
            <i class="fas fa-save"></i> Simpan & Update Hero Banner
        </button>
    </form>
</div>
@endsection