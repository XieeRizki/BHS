...
<div class="admin-page-header">
    <div>
        <h1 class="admin-page-title">Kelola Penghargaan</h1>
        <p class="admin-page-subtitle">Penghargaan & sertifikasi BHS yang tampil di halaman Profile</p>
    </div>
            ...
            <tbody>
                @forelse($awards as $award)
                    <tr>
                        ...
                        <td style="font-weight: 700; color: #111827;">{{ $award->year ?? '-' }}</td>
                        <td style="font-weight: 700;">{{ $award->order }}</td>
                        <td>
                            @if($award->is_active)
                        ...
                        <td>
                            <div class="action-group">
                                <button type="button" onclick="openEditAwardModal(this)"
                                ...
                                <form action="{{ route('admin.awards.destroy', $award) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus penghargaan ini?')" style="margin: 0;">
                                    @csrf @method('DELETE')
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="empty-container">
                                <p style="color: #6B7280; font-size: 0.9rem; margin-bottom: 1.25rem;">Belum ada data penghargaan yang ditambahkan.</p>
                                <button type="button" class="btn-bhs-primary" onclick="openModal('addModal')">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 5v14M5 12h14"/></svg>
                                    Tambah Penghargaan
                                </button>
...
<div class="modal-overlay" id="addModal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <p>Tambahkan penghargaan atau sertifikasi baru</p>
        </div>
        <form action="{{ route('admin.awards.store') }}" method="POST" enctype="multipart/form-data" style="display:flex; flex-direction:column; flex:1; overflow:hidden;">
            @csrf
            <div class="modal-body">
                <div class="form-group">
                    <label for="title">Judul Penghargaan <span class="required">*</span></label>
                    <input type="text" id="title" name="title" class="input-control" value="{{ old('title') }}" placeholder="Contoh: Anugerah Pariwisata BHS" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="issuer" name="issuer" class="input-control" value="{{ old('issuer') }}" placeholder="Contoh: Dinas Pariwisata Kabupaten Sumedang">
                </div>
                <div class="form-group">
                    <label for="year">Tahun</label>
                    <input type="text" id="year" name="year" class="input-control" value="{{ old('year') }}" placeholder="2026">
                </div>
                <div class="form-group">
            ...
            <div class="modal-actions">
                <button type="submit" class="btn-bhs-save-modal">
                    Simpan Penghargaan
                </button>
                <button type="button" class="btn-bhs-cancel-modal" onclick="closeModal('addModal')">
                    Batal
                </button>
            </div>
        </form>
...
<div class="modal-overlay" id="editModal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <p>Perbarui rincian data penghargaan</p>
        </div>
        <form action="" method="POST" id="editForm" enctype="multipart/form-data" style="display:flex; flex-direction:column; flex:1; overflow:hidden;">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="edit_issuer" name="issuer" class="input-control">
                </div>
                <div class="form-group">
                    <label for="edit_year">Tahun</label>
                    <input type="text" id="edit_year" name="year" class="input-control">
                </div>
                <div class="form-group">
                    <label for="edit_image">Gambar</label>
                    <div id="edit_image_preview" class="image-preview"></div>
                    <input type="file" id="edit_image" name="image" class="input-control" accept="image/*" onchange="previewImageAward()">
            ...
            <div class="modal-actions">
                ...
                <button type="button" class="btn-bhs-cancel-modal" onclick="closeModal('editModal')">
                    Batal
                </button>
            </div>
        </form>
